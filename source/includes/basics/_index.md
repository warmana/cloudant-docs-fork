...
As a hosted and managed database-as-a-service (DBaaS), Cloudant provides an [HTTP API](basics.html#http-api) to your [JSON](#json) data, and 24-hour operational support and maintenance.
