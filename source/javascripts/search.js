$(function () {
  ...
  if (window.location.host == 'cds-documentation.mybluemix.net') { //different search url for production
    query_url = 'https://cds-documentation.cloudant.com/master/_design/couchapp/_search/docs';
  }
