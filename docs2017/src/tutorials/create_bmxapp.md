...
>   **Note**: This code segment is provided as part of the ['starter' application pack](#starter).
...
The code for starting the Python web server is included as part of the ['starter' application pack](#starter):
