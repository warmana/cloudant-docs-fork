...
> Example shell instructions for creating a replication document:
...
> Example shell instructions for starting a replication:
...
> Example shell instructions for canceling a replication:
...
> Example shell instructions for enabling continuous replication:
...
> Example shell instructions for canceling the replication:
...
This can be done simply by determining the age of documents, and [deleting them](document.html#delete) if they are no longer required.
