...
_(This guide is based on a Blog article by Mike Rhodes: ["My top 5 tips for modelling your data to scale"](https://cloudant.com/blog/my-top-5-tips-for-modelling-your-data-to-scale/){:new_window},
originally published December 17, 2013.)_

# My top 5 tips for modelling your data to scale

Yesterday's post, ["Getting Started with Cloudant"](https://<account>.cloudant.com){:new_window}!,
highlighted helpful documentation for those who are new to our database service. For more 
advanced users who are already familiar with Cloudant, the article below considers the finer 
...
Behind our (https://<account>.cloudant.com/){:new_window} interface is a distributed database. 
...
["emitting each tag as a key in your view's map function](https://docs.cloudant.com/creating_views.html){:new_window}. 
...
```
{ "_id": "Joe McIllness", "operations": [ { "surgery": "heart bypass" }, { "surgery": "lumbar 
puncture" } ] }
```
...
```
{ "type": "operation", "patient": "Joe McIllness", "surgery": "heart bypass" }
{ "type": "operation", "patient": "Joe McIllness", "surgery": "lumbar puncture" }
```
...
For further reading, see this discussion on the ["data model for Foundbite"](https://cloudant.com/blog/foundbites-data-model-relational-db-vs-nosql-on-cloudant/){:new_window}, or this ["example from 
our friends at Twilio"](https://www.twilio.com/blog/2013/01/building-a-real-time-sms-voting-app-part-3-scaling-node-js-and-couchdb.html){:new_window}.
